...
test("Inline styles are extracted into a ‘<style>’ tag in ‘<head>’, with support for nested CSS (for example, media queries for responsive design, hover and other states, and so forth), and autoprefixer", () => {
  expect(
          ...
          <style>
              ...
              */
              :root {
                ...
                --transition-property--base: background-color, border-color, color,
